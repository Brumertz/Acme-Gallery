...
<style>
    .collection { display: flex; flex-direction: column; gap: 20px; }
    .item { display: flex; align-items: flex-start; border: 1px solid #ddd; padding: 15px; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: 0.3s; }
    .item:hover { box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2); }
    .image img { border-radius: 5px; }
    .details { flex: 1; }
    .details p { margin: 0; font-size: 1em; color: #333; }
    .details p strong { font-weight: bold; color: #000; }
</style>
